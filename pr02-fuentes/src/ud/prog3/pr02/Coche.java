...
public class Coche {
	...
	static double MASA;
	static double COEF_RZTO_SUELO;
	static double COEF_RZTO_AIRE;
	...
	public static double getCOEF_RZTO_SUELO() {
	...
	public static void setCOEF_RZTO_SUELO(double cOEF_RZTO_SUELO) {
		COEF_RZTO_SUELO = cOEF_RZTO_SUELO;
	}




	public static double getCOEF_RZTO_AIRE() {
	...
	public static void setCOEF_RZTO_AIRE(double cOEF_RZTO_AIRE) {
		COEF_RZTO_AIRE = cOEF_RZTO_AIRE;
	}
